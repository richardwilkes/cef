...
const (
	...
	ErrAddressInUse                              Errorcode = 72  // ERR_ADDRESS_IN_USE
	ErrSSLHandshakeNotCompleted                  Errorcode = 73  // ERR_SSL_HANDSHAKE_NOT_COMPLETED
	ErrSSLBadPeerPublicKey                       Errorcode = 74  // ERR_SSL_BAD_PEER_PUBLIC_KEY
	ErrSSLPinnedKeyNotInCertChain                Errorcode = 75  // ERR_SSL_PINNED_KEY_NOT_IN_CERT_CHAIN
	ErrClientAuthCertTypeUnsupported             Errorcode = 76  // ERR_CLIENT_AUTH_CERT_TYPE_UNSUPPORTED
	ErrOriginBoundCertGenerationTypeMismatch     Errorcode = 77  // ERR_ORIGIN_BOUND_CERT_GENERATION_TYPE_MISMATCH
	ErrSSLDecryptErrorAlert                      Errorcode = 78  // ERR_SSL_DECRYPT_ERROR_ALERT
	ErrWsThrottleQueueTooLarge                   Errorcode = 79  // ERR_WS_THROTTLE_QUEUE_TOO_LARGE
	ErrSSLServerCertChanged                      Errorcode = 80  // ERR_SSL_SERVER_CERT_CHANGED
	ErrSSLUnrecognizedNameAlert                  Errorcode = 81  // ERR_SSL_UNRECOGNIZED_NAME_ALERT
	ErrSocketSetReceiveBufferSizeError           Errorcode = 82  // ERR_SOCKET_SET_RECEIVE_BUFFER_SIZE_ERROR
	ErrSocketSetSendBufferSizeError              Errorcode = 83  // ERR_SOCKET_SET_SEND_BUFFER_SIZE_ERROR
	ErrSocketReceiveBufferSizeUnchangeable       Errorcode = 84  // ERR_SOCKET_RECEIVE_BUFFER_SIZE_UNCHANGEABLE
	ErrSocketSendBufferSizeUnchangeable          Errorcode = 85  // ERR_SOCKET_SEND_BUFFER_SIZE_UNCHANGEABLE
	ErrSSLClientAuthCertBadFormat                Errorcode = 86  // ERR_SSL_CLIENT_AUTH_CERT_BAD_FORMAT
	ErrIcannNameCollision                        Errorcode = 87  // ERR_ICANN_NAME_COLLISION
	ErrSSLServerCertBadFormat                    Errorcode = 88  // ERR_SSL_SERVER_CERT_BAD_FORMAT
	ErrCTSthParsingFailed                        Errorcode = 89  // ERR_CT_STH_PARSING_FAILED
	ErrCTSthIncomplete                           Errorcode = 90  // ERR_CT_STH_INCOMPLETE
	ErrUnableToReuseConnectionForProxyAuth       Errorcode = 91  // ERR_UNABLE_TO_REUSE_CONNECTION_FOR_PROXY_AUTH
	ErrCTConsistencyProofParsingFailed           Errorcode = 92  // ERR_CT_CONSISTENCY_PROOF_PARSING_FAILED
	ErrSSLObsoleteCipher                         Errorcode = 93  // ERR_SSL_OBSOLETE_CIPHER
	ErrWsUpgrade                                 Errorcode = 94  // ERR_WS_UPGRADE
	ErrReadIfReadyNotImplemented                 Errorcode = 95  // ERR_READ_IF_READY_NOT_IMPLEMENTED
	ErrNoBufferSpace                             Errorcode = 96  // ERR_NO_BUFFER_SPACE
	...
	ErrCertAuthorityInvalid                      Errorcode = 104 // ERR_CERT_AUTHORITY_INVALID
	ErrCertContainsErrors                        Errorcode = 105 // ERR_CERT_CONTAINS_ERRORS
	ErrCertNoRevocationMechanism                 Errorcode = 106 // ERR_CERT_NO_REVOCATION_MECHANISM
	ErrCertUnableToCheckRevocation               Errorcode = 107 // ERR_CERT_UNABLE_TO_CHECK_REVOCATION
	ErrCertRevoked                               Errorcode = 108 // ERR_CERT_REVOKED
	ErrCertInvalid                               Errorcode = 109 // ERR_CERT_INVALID
	ErrCertWeakSignatureAlgorithm                Errorcode = 110 // ERR_CERT_WEAK_SIGNATURE_ALGORITHM
	ErrCertNonUniqueName                         Errorcode = 111 // ERR_CERT_NON_UNIQUE_NAME
	ErrCertWeakKey                               Errorcode = 112 // ERR_CERT_WEAK_KEY
	ErrCertNameConstraintViolation               Errorcode = 113 // ERR_CERT_NAME_CONSTRAINT_VIOLATION
	ErrCertValidityTooLong                       Errorcode = 114 // ERR_CERT_VALIDITY_TOO_LONG
	ErrCertificateTransparencyRequired           Errorcode = 115 // ERR_CERTIFICATE_TRANSPARENCY_REQUIRED
	ErrCertSymantecLegacy                        Errorcode = 116 // ERR_CERT_SYMANTEC_LEGACY
	ErrCertEnd                                   Errorcode = 117 // ERR_CERT_END
	ErrInvalidURL                                Errorcode = 118 // ERR_INVALID_URL
	ErrDisallowedURLScheme                       Errorcode = 119 // ERR_DISALLOWED_URL_SCHEME
	ErrUnknownURLScheme                          Errorcode = 120 // ERR_UNKNOWN_URL_SCHEME
	ErrInvalidRedirect                           Errorcode = 121 // ERR_INVALID_REDIRECT
	ErrTooManyRedirects                          Errorcode = 122 // ERR_TOO_MANY_REDIRECTS
	ErrUnsafeRedirect                            Errorcode = 123 // ERR_UNSAFE_REDIRECT
	ErrUnsafePort                                Errorcode = 124 // ERR_UNSAFE_PORT
	ErrInvalidResponse                           Errorcode = 125 // ERR_INVALID_RESPONSE
	ErrInvalidChunkedEncoding                    Errorcode = 126 // ERR_INVALID_CHUNKED_ENCODING
	ErrMethodNotSupported                        Errorcode = 127 // ERR_METHOD_NOT_SUPPORTED
	ErrUnexpectedProxyAuth                       Errorcode = 128 // ERR_UNEXPECTED_PROXY_AUTH
	ErrEmptyResponse                             Errorcode = 129 // ERR_EMPTY_RESPONSE
	ErrResponseHeadersTooBig                     Errorcode = 130 // ERR_RESPONSE_HEADERS_TOO_BIG
	ErrPacStatusNotOk                            Errorcode = 131 // ERR_PAC_STATUS_NOT_OK
	ErrPacScriptFailed                           Errorcode = 132 // ERR_PAC_SCRIPT_FAILED
	ErrRequestRangeNotSatisfiable                Errorcode = 133 // ERR_REQUEST_RANGE_NOT_SATISFIABLE
	ErrMalformedIdentity                         Errorcode = 134 // ERR_MALFORMED_IDENTITY
	ErrContentDecodingFailed                     Errorcode = 135 // ERR_CONTENT_DECODING_FAILED
	ErrNetworkIOSuspended                        Errorcode = 136 // ERR_NETWORK_IO_SUSPENDED
	ErrSynReplyNotReceived                       Errorcode = 137 // ERR_SYN_REPLY_NOT_RECEIVED
	ErrEncodingConversionFailed                  Errorcode = 138 // ERR_ENCODING_CONVERSION_FAILED
	ErrUnrecognizedFtpDirectoryListingFormat     Errorcode = 139 // ERR_UNRECOGNIZED_FTP_DIRECTORY_LISTING_FORMAT
	ErrNoSupportedProxies                        Errorcode = 140 // ERR_NO_SUPPORTED_PROXIES
	ErrSpdyProtocolError                         Errorcode = 141 // ERR_SPDY_PROTOCOL_ERROR
	ErrInvalidAuthCredentials                    Errorcode = 142 // ERR_INVALID_AUTH_CREDENTIALS
	ErrUnsupportedAuthScheme                     Errorcode = 143 // ERR_UNSUPPORTED_AUTH_SCHEME
	ErrEncodingDetectionFailed                   Errorcode = 144 // ERR_ENCODING_DETECTION_FAILED
	ErrMissingAuthCredentials                    Errorcode = 145 // ERR_MISSING_AUTH_CREDENTIALS
	ErrUnexpectedSecurityLibraryStatus           Errorcode = 146 // ERR_UNEXPECTED_SECURITY_LIBRARY_STATUS
	ErrMisconfiguredAuthEnvironment              Errorcode = 147 // ERR_MISCONFIGURED_AUTH_ENVIRONMENT
	ErrUndocumentedSecurityLibraryStatus         Errorcode = 148 // ERR_UNDOCUMENTED_SECURITY_LIBRARY_STATUS
	ErrResponseBodyTooBigToDrain                 Errorcode = 149 // ERR_RESPONSE_BODY_TOO_BIG_TO_DRAIN
	ErrResponseHeadersMultipleContentLength      Errorcode = 150 // ERR_RESPONSE_HEADERS_MULTIPLE_CONTENT_LENGTH
	ErrIncompleteSpdyHeaders                     Errorcode = 151 // ERR_INCOMPLETE_SPDY_HEADERS
	ErrPacNotInDhcp                              Errorcode = 152 // ERR_PAC_NOT_IN_DHCP
	ErrResponseHeadersMultipleContentDisposition Errorcode = 153 // ERR_RESPONSE_HEADERS_MULTIPLE_CONTENT_DISPOSITION
	ErrResponseHeadersMultipleLocation           Errorcode = 154 // ERR_RESPONSE_HEADERS_MULTIPLE_LOCATION
	ErrSpdyServerRefusedStream                   Errorcode = 155 // ERR_SPDY_SERVER_REFUSED_STREAM
	ErrSpdyPingFailed                            Errorcode = 156 // ERR_SPDY_PING_FAILED
	ErrContentLengthMismatch                     Errorcode = 157 // ERR_CONTENT_LENGTH_MISMATCH
	ErrIncompleteChunkedEncoding                 Errorcode = 158 // ERR_INCOMPLETE_CHUNKED_ENCODING
	ErrQuicProtocolError                         Errorcode = 159 // ERR_QUIC_PROTOCOL_ERROR
	ErrResponseHeadersTruncated                  Errorcode = 160 // ERR_RESPONSE_HEADERS_TRUNCATED
	ErrQuicHandshakeFailed                       Errorcode = 161 // ERR_QUIC_HANDSHAKE_FAILED
	ErrSpdyInadequateTransportSecurity           Errorcode = 162 // ERR_SPDY_INADEQUATE_TRANSPORT_SECURITY
	ErrSpdyFlowControlError                      Errorcode = 163 // ERR_SPDY_FLOW_CONTROL_ERROR
	ErrSpdyFrameSizeError                        Errorcode = 164 // ERR_SPDY_FRAME_SIZE_ERROR
	ErrSpdyCompressionError                      Errorcode = 165 // ERR_SPDY_COMPRESSION_ERROR
	ErrProxyAuthRequestedWithNoConnection        Errorcode = 166 // ERR_PROXY_AUTH_REQUESTED_WITH_NO_CONNECTION
	ErrHTTP11Required                            Errorcode = 167 // ERR_HTTP_1_1_REQUIRED
	ErrProxyHTTP11Required                       Errorcode = 168 // ERR_PROXY_HTTP_1_1_REQUIRED
	ErrPacScriptTerminated                       Errorcode = 169 // ERR_PAC_SCRIPT_TERMINATED
	ErrInvalidHTTPResponse                       Errorcode = 170 // ERR_INVALID_HTTP_RESPONSE
	ErrContentDecodingInitFailed                 Errorcode = 171 // ERR_CONTENT_DECODING_INIT_FAILED
	ErrSpdyRstStreamNoErrorReceived              Errorcode = 172 // ERR_SPDY_RST_STREAM_NO_ERROR_RECEIVED
	ErrSpdyPushedStreamNotAvailable              Errorcode = 173 // ERR_SPDY_PUSHED_STREAM_NOT_AVAILABLE
	ErrSpdyClaimedPushedStreamResetByServer      Errorcode = 174 // ERR_SPDY_CLAIMED_PUSHED_STREAM_RESET_BY_SERVER
	ErrTooManyRetries                            Errorcode = 175 // ERR_TOO_MANY_RETRIES
	ErrSpdyStreamClosed                          Errorcode = 176 // ERR_SPDY_STREAM_CLOSED
	ErrSpdyClientRefusedStream                   Errorcode = 177 // ERR_SPDY_CLIENT_REFUSED_STREAM
	ErrSpdyPushedResponseDoesNotMatch            Errorcode = 178 // ERR_SPDY_PUSHED_RESPONSE_DOES_NOT_MATCH
	ErrCacheMiss                                 Errorcode = 179 // ERR_CACHE_MISS
	ErrCacheReadFailure                          Errorcode = 180 // ERR_CACHE_READ_FAILURE
	ErrCacheWriteFailure                         Errorcode = 181 // ERR_CACHE_WRITE_FAILURE
	ErrCacheOperationNotSupported                Errorcode = 182 // ERR_CACHE_OPERATION_NOT_SUPPORTED
	ErrCacheOpenFailure                          Errorcode = 183 // ERR_CACHE_OPEN_FAILURE
	ErrCacheCreateFailure                        Errorcode = 184 // ERR_CACHE_CREATE_FAILURE
	ErrCacheRace                                 Errorcode = 185 // ERR_CACHE_RACE
	ErrCacheChecksumReadFailure                  Errorcode = 186 // ERR_CACHE_CHECKSUM_READ_FAILURE
	ErrCacheChecksumMismatch                     Errorcode = 187 // ERR_CACHE_CHECKSUM_MISMATCH
	ErrCacheLockTimeout                          Errorcode = 188 // ERR_CACHE_LOCK_TIMEOUT
	ErrCacheAuthFailureAfterRead                 Errorcode = 189 // ERR_CACHE_AUTH_FAILURE_AFTER_READ
	ErrCacheEntryNotSuitable                     Errorcode = 190 // ERR_CACHE_ENTRY_NOT_SUITABLE
	ErrCacheDoomFailure                          Errorcode = 191 // ERR_CACHE_DOOM_FAILURE
	ErrCacheOpenOrCreateFailure                  Errorcode = 192 // ERR_CACHE_OPEN_OR_CREATE_FAILURE
	ErrInsecureResponse                          Errorcode = 193 // ERR_INSECURE_RESPONSE
	ErrNoPrivateKeyForCert                       Errorcode = 194 // ERR_NO_PRIVATE_KEY_FOR_CERT
	ErrAddUserCertFailed                         Errorcode = 195 // ERR_ADD_USER_CERT_FAILED
	ErrInvalidSignedExchange                     Errorcode = 196 // ERR_INVALID_SIGNED_EXCHANGE
	ErrFtpFailed                                 Errorcode = 197 // ERR_FTP_FAILED
	ErrFtpServiceUnavailable                     Errorcode = 198 // ERR_FTP_SERVICE_UNAVAILABLE
	ErrFtpTransferAborted                        Errorcode = 199 // ERR_FTP_TRANSFER_ABORTED
	ErrFtpFileBusy                               Errorcode = 200 // ERR_FTP_FILE_BUSY
	ErrFtpSyntaxError                            Errorcode = 201 // ERR_FTP_SYNTAX_ERROR
	ErrFtpCommandNotSupported                    Errorcode = 202 // ERR_FTP_COMMAND_NOT_SUPPORTED
	ErrFtpBadCommandSequence                     Errorcode = 203 // ERR_FTP_BAD_COMMAND_SEQUENCE
	ErrPkcs12ImportBadPassword                   Errorcode = 204 // ERR_PKCS12_IMPORT_BAD_PASSWORD
	ErrPkcs12ImportFailed                        Errorcode = 205 // ERR_PKCS12_IMPORT_FAILED
	ErrImportCaCertNotCa                         Errorcode = 206 // ERR_IMPORT_CA_CERT_NOT_CA
	ErrImportCertAlreadyExists                   Errorcode = 207 // ERR_IMPORT_CERT_ALREADY_EXISTS
	ErrImportCaCertFailed                        Errorcode = 208 // ERR_IMPORT_CA_CERT_FAILED
	ErrImportServerCertFailed                    Errorcode = 209 // ERR_IMPORT_SERVER_CERT_FAILED
	ErrPkcs12ImportInvalidMac                    Errorcode = 210 // ERR_PKCS12_IMPORT_INVALID_MAC
	ErrPkcs12ImportInvalidFile                   Errorcode = 211 // ERR_PKCS12_IMPORT_INVALID_FILE
	ErrPkcs12ImportUnsupported                   Errorcode = 212 // ERR_PKCS12_IMPORT_UNSUPPORTED
	ErrKeyGenerationFailed                       Errorcode = 213 // ERR_KEY_GENERATION_FAILED
